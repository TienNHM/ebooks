...
| Thư mục | Mô tả |
|---------|-------|
| [SQL-Server](./SQL-Server/) | SQL Server, SQL/PL-SQL, Oracle, MySQL, tài liệu W3Schools |
| [HCMUTE](./HCMUTE/) | Slide và bài tập CSDL – ĐH Sư phạm Kỹ thuật TP.HCM |

---

## 📘 Giáo trình CSDL (tiếng Việt)
